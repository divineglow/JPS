function druid_feral(self)
	...
	local possibleSpells = {
    	...
    	-- Survival Instincts
		{ "Survival Instincts",		jps.hp() < .4 and not jps.buff("Barkskin")},
    
    	-- Healthstone if you get low.
    	{ "Healthstone", 			jps.hp() < .35 and GetItemCount("Healthstone", 0, 1) > 0 },
		...
		{ "Rip", 					not jps.MultiTarget and (energy >= ripCost or clearcasting) and cp >= 5 and cenarionStacks > 0 and executePhase and not jps.RipBuffed }, -- stronger rip detection
